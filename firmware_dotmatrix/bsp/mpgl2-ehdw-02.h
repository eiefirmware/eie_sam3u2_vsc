...
@brief This file provides header information for the mpgl2-ehdw-02 board.
***********************************************************************************************************************/
...
*/
typedef enum {RED0 = 0, RED1, RED2, RED3, 
              GREEN0, GREEN1, GREEN2, GREEN3, 
              BLUE0, BLUE1, BLUE2, BLUE3, LCD_BL} LedNameType;

#define U8_TOTAL_LEDS             (u8)13      /*!< @brief Total number of LEDs in the system */
...
#define U8_TOTAL_BUTTONS          (u8)2       /*!< @brief Total number of Buttons in the system */
...
*/
typedef enum {BUZZER1 = AT91C_PWMC_CHID0} BuzzerChannelType;
...
#define ADC_CHANNEL_ARRAY      {ADC12_BLADE_AN0, ADC12_BLADE_AN1} /*!< @brief ADC channel group */
...
!!!!! GPIO pin names
***********************************************************************************************************************/
/* Hardware Definition for PCB MPGL1-EHDW-02 */
