/*!*********************************************************************************************************************
@file ascii_board_test.c                                                                
@brief Application to completely test the EiE ASCII development board.
...
All Global variable names shall start with "G_<type>BoardTest"
***********************************************************************************************************************/
/* New variables */
...
***********************************************************************************************************************/
static fnCode_type BoardTest_pfStateMachine;             /*!< @brief The state machine function pointer */
...
/*!--------------------------------------------------------------------------------------------------------------------
@fn void BoardTestInitialize(void)
...
/*!----------------------------------------------------------------------------------------------------------------------
@fn void BoardTestRunActiveState(void)
...
/*--------------------------------------------------------------------------------------------------------------------*/
/* Watch for user input and respond appropriately */
