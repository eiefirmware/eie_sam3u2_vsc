...
#define C3                   (u16)NOTE_C3
#define C3S                  (u16)NOTE_C3_SHARP
#define D3                   (u16)NOTE_D3
#define D3S                  (u16)NOTE_D3_SHARP
#define E3                   (u16)NOTE_E3
#define F3                   (u16)NOTE_F3
#define F3S                  (u16)NOTE_F3_SHARP
#define G3                   (u16)NOTE_G3
#define G3S                  (u16)NOTE_G3_SHARP
#define A3                   (u16)NOTE_A3
#define A3S                  (u16)NOTE_A3_SHARP
#define B3                   (u16)NOTE_B3
#define C4                   (u16)NOTE_C4  /* Middle C */
#define C4S                  (u16)NOTE_C4_SHARP
#define D4                   (u16)NOTE_D4
#define D4S                  (u16)NOTE_D4_SHARP
#define E4                   (u16)NOTE_E4
#define F4                   (u16)NOTE_F4
#define F4S                  (u16)NOTE_F4_SHARP
#define G4                   (u16)NOTE_G4
#define G4S                  (u16)NOTE_G4_SHARP
#define A4                   (u16)NOTE_A4
#define A4S                  (u16)NOTE_A4_SHARP
#define B4                   (u16)NOTE_B4
#define C5                   (u16)NOTE_C5
#define C5S                  (u16)NOTE_C5_SHARP
#define D5                   (u16)NOTE_D5
#define D5S                  (u16)NOTE_D5_SHARP
#define E5                   (u16)NOTE_E5
#define F5                   (u16)NOTE_F5
#define F5S                  (u16)NOTE_F5_SHARP
#define G5                   (u16)NOTE_G5
#define G5S                  (u16)NOTE_G5_SHARP
#define A5                   (u16)NOTE_A5
#define A5S                  (u16)NOTE_A5_SHARP
#define B5                   (u16)NOTE_B5
#define C6                   (u16)NOTE_C6
#define C6S                  (u16)NOTE_C6_SHARP
#define D6                   (u16)NOTE_D6
#define D6S                  (u16)NOTE_D6_SHARP
#define E6                   (u16)NOTE_E6
#define F6                   (u16)NOTE_F6
#define F6S                  (u16)NOTE_F6_SHARP
#define G6                   (u16)NOTE_G6
#define G6S                  (u16)NOTE_G6_SHARP
#define A6                   (u16)NOTE_A6
#define A6S                  (u16)NOTE_A6_SHARP
#define B6                   (u16)NOTE_B6
#define NO                   (u16)NONE